...
$connection = pg_connect('host=devreo.info dbname=devreo user=radmin password=R30$peed3');
$host = "devreo.info";
$db = "devreo";
$username = "radmin";
$password = 'R30$peed3';
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <p>I am a <?php echo $age; ?> year old, full-time Software Developer with <?php echo $experience; ?>
                        ...
                        if ($plural) {
                            echo "s";
                        } ?> of professional experience. I love every second of what I do and am
                            ...
                            <div class="col-md-6">
                                <div class="text-left">
                                    <p class="project-description">This is a description about one of the projects that
                                        I will have created. This is a simply a template to demostrate how it will look.
                                </div>
                            </div>
                            <div class="col-md-6">
